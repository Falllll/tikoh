...
import Authenticated from '@/Layouts/Authenticated';</script>
<template>
  <Authenticated>
                ...
                >
                  <MenuItems class="origin-top-left mt-2 focus:outline-none absolute left-0 bg-white overflow-hidden rounded-md shadow-lg border w-40">
                    <MenuItem v-slot="{active}">
                      <a :class="{'bg-gray-100': active}" class="block px-4 py-2 text-sm text-gray-700" href="#">Add card</a>
                    </MenuItem>
                    <MenuItem v-slot="{active}">
                      <a :class="{'bg-gray-100': active}" class="block px-4 py-2 text-sm text-red-600" href="#">Delete list</a>
                    </MenuItem>
                  </MenuItems>
                </transition>
              </Menu>
              ...
              <div class="px-3 flex-1 overflow-y-auto">
                <ul class="space-y-3">
                  <li
                    ...
                    <a class="text-sm" href="#">card item</a>
